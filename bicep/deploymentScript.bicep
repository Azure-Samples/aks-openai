...
output serviceAccountName string = deploymentScript.properties.outputs.serviceAccountName
output prometheus string = deploymentScript.properties.outputs.prometheus
