...
# OpenAI
openAiName="GreyOpenAi "
openAiResourceGroupName="GreyRG"
openAiType="azure_ad"
openAiBase="https://greyopenai.openai.azure.com/"
...
# AKS Cluster
aksClusterName="GreyAks"
aksResourceGroupName="GreyRG"
